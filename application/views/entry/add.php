<h3>Thêm Sản phẩm - Dịch vụ mới</h3>
<hr>
<form action="" method="post" class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" id="phone" placeholder="Chỉ chứa 10 hoặc 11 chữ số, không chứa khoảng trắng" name="phone" value="<?php echo set_value('phone'); ?>">
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-md-4" for="fb_name">Tên Facebook (không bắt buộc):</label>
		<div class="col-md-6">
			<input type="text" class="form-control" id="fb_name" name="fb_name" value="<?php echo set_value('fb_name'); ?>">
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-md-4" for="fb_link">Link Facebook (không bắt buộc):</label>
		<div class="col-md-6">
			<input type="text" class="form-control" id="fb_link" name="fb_link" placeholder="Bắt đầu bằng https://facebook.com/..." value="<?php echo set_value('fb_link'); ?>">
		</div>
	</div>
	<div class="form-group">
	...
	<input type="submit" class="btn btn-primary col-md-offset-6" name="btn_submit" value="Thêm mới">
